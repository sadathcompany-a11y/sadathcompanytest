    ...
    <div className="min-h-screen bg-background text-foreground px-6 py-20">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose max-w-none space-y-6 text-muted-foreground leading-relaxed">
          ...
          <h2 className="font-serif text-xl text-foreground">9. Support After Launch</h2>
          ...
          <h2 className="font-serif text-xl text-foreground">10. Hosting</h2>
          ...
          <h2 className="font-serif text-xl text-foreground">11. Third-Party Services</h2>
          ...
          <h2 className="font-serif text-xl text-foreground">12. Confidentiality</h2>
